...
PipRail is **three things, no server.** It lets any HTTP request demand a crypto payment, finally
putting the HTTP `402 Payment Required` status to use, and lets any agent pay one
