...
description: 'One command scaffolds a self-hosted x402 merchant that accepts stablecoin payments from humans and AI agents, straight to your wallet. Paste a public address.'
sidebar:
  order: 2
---
...
account, with your public address already baked in, nothing else to configure and no secret to
