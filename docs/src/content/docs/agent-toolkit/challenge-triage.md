...
It is a **pure, never-throwing read**, with no chain libraries and no I/O. You feed it a challenge you
...
`offeredSchemes` and `offeredNetworks` are the most useful for messaging, because they tell the agent
