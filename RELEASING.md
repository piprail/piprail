...
**ops-script parse** → the **env-loader tests** → **`npm run sync`** (63 rules) → `build` site →
...
As of 2026-08-28 this is no longer just a version check — it is **63 rules across 14 domains**
