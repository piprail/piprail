...
| File | What it shows |
| --- | --- |
| [`without-402.mjs`](./without-402.mjs) | A runnable mock of "just send the money." Prints the three **verification** holes. `node examples/why-402/without-402.mjs` |
| [`without-402-server.mjs`](./without-402-server.mjs) | The **backend you'd have to run** without 402 — listener, correlation/accounts, async notify. `node examples/why-402/without-402-server.mjs` |
