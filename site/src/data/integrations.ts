...
export const liveIntegrations: Integration[] = [
  {
    ...
    tag: 'ClawHub skill',
    blurb:
      'Hand an OpenClaw agent a budget-bound wallet across every major chain. Install the ClawHub skill or add one mcp.servers entry and the eight piprail_* tools appear, capped by a spend policy.',
