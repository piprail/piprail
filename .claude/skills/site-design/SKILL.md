...
- **AEO/GEO files** live in `site/public/`: `llms.txt` (concise index) + `llms-full.txt` (full pitch). Keep their version/last-updated headers current when the SDK/MCP ships.
