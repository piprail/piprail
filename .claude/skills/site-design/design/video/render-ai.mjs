...
await p.goto(pathToFileURL('/Users/john/Sites/piprail/.claude/skills/site-design/design/video/card-ai.html').href,{waitUntil:'load'});
await p.evaluate(()=>document.fonts.ready).catch(()=>{});
await p.waitForTimeout(350);
await p.screenshot({ path:'/Users/john/Sites/piprail/.claude/skills/site-design/design/video/_ai2160.png' });
