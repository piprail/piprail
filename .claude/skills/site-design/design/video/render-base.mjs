...
await p.goto(pathToFileURL('/Users/john/Sites/piprail/.claude/skills/site-design/design/video/card-base.html').href,{waitUntil:'load'});
await p.evaluate(()=>document.fonts.ready).catch(()=>{});
await p.waitForTimeout(350);
await p.screenshot({ path:'/Users/john/Sites/piprail/.claude/skills/site-design/design/video/_base2160.png' });
