...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .copy h1 { font-size:84px; font-weight:800; letter-spacing:-0.03em; line-height:1; }
...
<body>
  ...
  <div class="hero">
    ...
    <div class="copy">
      ...
      <p>Your <b>AI agent</b> pays any <b>x402</b> endpoint on ${c.name}.<br>One <b>npm install</b> — no backend, no facilitator, no fee.</p>
    </div>
  </div>
