#!/usr/bin/env node
// Launch card (1080×1080, square) — "PipRail × elizaOS". Same system as render-hermes.mjs:
// a centered co-brand lockup as the hero, one confident headline, one muted sub-line, docs in the
// footer. True-black canvas, one emerald whisper of glow. (branding SKILL §2: #2ee6a6 accent,
// Space Grotesk + Inter + JetBrains Mono.)
//   node render-elizaos.mjs  ->  ./elizaos-launch.png  (1080×1080)
...
const elizaLogo = b64(resolve(REPO, 'site/public/integrations/elizaos.webp'), 'image/webp')
...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  /* Co-brand lockup — the hero. PipRail × elizaOS. */
  ...
  .mark img.app { border-radius:26px; box-shadow:0 18px 50px rgba(0,0,0,0.55); }
  ...
  .head p { margin-top:24px; font-size:30px; line-height:1.5; color:#c5c9cf; font-weight:400; max-width:880px; }
...
<body>
  ...
  <div class="lockup">
    ...
    <span class="x">×</span>
    <div class="mark"><img class="app" src="${elizaLogo}"><span class="nm">elizaOS</span></div>
  </div>

  <div class="head">
    <h1>Agent payments,<br>native to <span class="em">elizaOS</span>.</h1>
    <p>Your elizaOS agent pays any x402 API by itself —<br><b>self-custodial, every chain, no fee.</b></p>
  </div>

  <footer><b>docs.piprail.com/integrations/elizaos</b></footer>
</body></html>`

const out = resolve(__dirname, 'elizaos-launch.png')
writeFileSync(resolve(__dirname, 'elizaos-launch.html'), html)
