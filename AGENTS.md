...
integrations/ first-party framework integrations (one folder per framework, standalone + publishable): openclaw/piprail/ (ClawHub skill @piprail, + verify.mjs) + README.md + TESTING.md
